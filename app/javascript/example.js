$(document).on('turbolinks:load', function() {
    ...
    $(".send_data_example").on('click',function(){
        ...
        var question_text = '.example-text' + clickButtonHref
        var next_question_text = '.example-text' + clickButtonNextHref

        $(question_text).fadeOut(function(){    // 1~10までの値であれば次の質問に遷移
            $(next_question_text).fadeIn();
        });
